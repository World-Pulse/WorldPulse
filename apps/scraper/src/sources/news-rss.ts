 ...
 *
 * Ingests 125+ international news RSS feeds and creates WorldPulse signals from
...
export const NEWS_SOURCE_REGISTRY: NewsSource[] = [
  ...
  // Core maritime industry sources for shipping, ports, chokepoints, piracy, naval
  {
  ...
  },
  {
    ...
    defaultLat:      37.77,
    defaultLng:      -122.42,
    defaultLocation: 'San Francisco, United States',
    extraTags:       ['maritime', 'shipping', 'naval', 'piracy', 'ports', 'chokepoints', 'offshore'],
    language:        'en',
  },
  {
    id:              'splash247',
    ...
    defaultLng:      103.85,
    defaultLocation: 'Singapore',
    extraTags:       ['maritime', 'shipping', 'tanker', 'bulk', 'container', 'ports', 'trade'],
    language:        'en',
  },
  {
    ...
    extraTags:       ['maritime', 'shipping', 'tanker', 'dry-bulk', 'freight-rates', 'trade'],
    language:        'en',
  },
  {
    id:              'tradewinds-news',
    name:            'TradeWinds',
    feedUrl:         'https://www.tradewindsnews.com/rss',
    category:        'economy',
    biasLabel:       'center',
    reliability:     0.83,
    countryCode:     'NO',
    ...
    extraTags:       ['maritime', 'shipping', 'offshore', 'lng', 'tanker', 'container', 'trade'],
    language:        'en',
  },
  {
    ...
    defaultLng:      -0.11,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['maritime', 'shipping', 'cruise', 'ports', 'offshore', 'regulations'],
    language:        'en',
  },
  {
    id:              'safety4sea',
    name:            'SAFETY4SEA',
    feedUrl:         'https://safety4sea.com/feed/',
    category:        'economy',
    biasLabel:       'center',
    reliability:     0.77,
    countryCode:     'GR',
    defaultLat:      37.94,
    defaultLng:      23.65,
    defaultLocation: 'Piraeus, Greece',
    extraTags:       ['maritime', 'shipping', 'safety', 'environment', 'regulations', 'piracy'],
    language:        'en',
  },
  {
    id:              'imo-news',
    name:            'International Maritime Organization',
    feedUrl:         'https://www.imo.org/en/MediaCentre/Pages/WhatsNew.aspx/RSS',
    category:        'economy',
    biasLabel:       'center',
    reliability:     0.93,
    countryCode:     'GB',
    ...
    defaultLng:      -0.12,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['maritime', 'imo', 'regulations', 'institutional', 'shipping', 'safety', 'environment'],
    language:        'en',
  },
  // ── Maritime: Piracy & Security ────────────────────────────────────────────
  {
    id:              'icc-imb-piracy',
    name:            'ICC IMB Piracy Reporting Centre',
    feedUrl:         'https://www.icc-ccs.org/index.php/piracy-reporting-centre?format=feed&type=rss',
    category:        'conflict',
    biasLabel:       'center',
    reliability:     0.91,
    countryCode:     'GB',
    ...
    defaultLng:      -0.11,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['maritime', 'piracy', 'security', 'armed-robbery', 'hijacking', 'gulf-of-guinea', 'strait-of-malacca'],
    language:        'en',
  },
  {
    id:              'maritime-global-security',
    name:            'Maritime Global Security',
    feedUrl:         'https://maritimeglobalsecurity.org/feed/',
    category:        'conflict',
    biasLabel:       'center',
    reliability:     0.80,
    countryCode:     'GB',
    ...
    defaultLng:      -0.11,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['maritime', 'piracy', 'security', 'naval', 'chokepoints', 'red-sea', 'houthi'],
    language:        'en',
  },
  // ── Maritime: Naval & Defense ──────────────────────────────────────────────
  {
    ...
    defaultLng:      2.35,
    defaultLocation: 'Paris, France',
    extraTags:       ['maritime', 'naval', 'defense', 'submarines', 'warships', 'military'],
    language:        'en',
  },
  {
    id:              'usni-news',
    ...
    defaultLat:      38.98,
    defaultLng:      -76.49,
    defaultLocation: 'Annapolis, United States',
    extraTags:       ['maritime', 'naval', 'usn', 'defense', 'carrier-strike-groups', 'pacific', 'military'],
    language:        'en',
  },
  // ── Maritime: Port & Chokepoint Intelligence ───────────────────────────────
  {
    id:              'port-technology',
    name:            'Port Technology International',
    feedUrl:         'https://www.porttechnology.org/feed/',
    category:        'economy',
    biasLabel:       'center',
    reliability:     0.78,
    countryCode:     'GB',
    ...
    defaultLng:      -0.11,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['maritime', 'ports', 'logistics', 'automation', 'supply-chain', 'chokepoints'],
    language:        'en',
  },
  {
    id:              'loadstar',
    ...
    defaultLng:      -0.11,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['maritime', 'shipping', 'logistics', 'freight', 'supply-chain', 'container', 'ports'],
    language:        'en',
  },
  {
    id:              'freightwaves',
    name:            'FreightWaves',
    feedUrl:         'https://www.freightwaves.com/news/rss.xml',
    category:        'economy',
    biasLabel:       'center',
    reliability:     0.79,
    countryCode:     'US',
    defaultLat:      35.96,
    defaultLng:      -83.92,
    defaultLocation: 'Chattanooga, United States',
    extraTags:       ['maritime', 'freight', 'logistics', 'trucking', 'supply-chain', 'shipping', 'trade'],
    language:        'en',
  },
  // ── Maritime: Sanctions & Compliance ───────────────────────────────────────
  {
    id:              'windward-intelligence',
    name:            'Windward Maritime AI Blog',
    feedUrl:         'https://windward.ai/blog/feed/',
    category:        'economy',
    biasLabel:       'center',
    reliability:     0.76,
    countryCode:     'IL',
    ...
    defaultLng:      34.78,
    defaultLocation: 'Tel Aviv, Israel',
    extraTags:       ['maritime', 'sanctions', 'dark-shipping', 'ais', 'compliance', 'deceptive-shipping'],
    language:        'en',
  },

  // ── Tier 6 — Diversity expansion: health, conflict, elections, technology, disaster ──
  // Added to address category imbalance (Apr 23 quality audit)
  {
    id:              'who-news',
    name:            'WHO News',
    ...
    extraTags:       ['who', 'health', 'pandemic', 'global-health', 'institutional'],
    language:        'en',
  },
  {
    id:              'stat-news',
    ...
    defaultLat:      42.36,
    defaultLng:      -71.06,
    defaultLocation: 'Boston, United States',
    extraTags:       ['stat', 'health', 'medicine', 'pharma', 'biotech'],
    language:        'en',
  },
  {
    id:              'cidrap',
    ...
    defaultLat:      44.97,
    defaultLng:      -93.23,
    defaultLocation: 'Minneapolis, United States',
    extraTags:       ['cidrap', 'infectious-disease', 'pandemic', 'epidemiology'],
    language:        'en',
  },
  {
    id:              'the-lancet',
    ...
    defaultLng:      -0.13,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['lancet', 'medical-research', 'health', 'peer-reviewed'],
    language:        'en',
  },
  {
    id:              'iiss-blog',
    name:            'IISS Analysis',
    feedUrl:         'https://www.iiss.org/rss/',
    category:        'conflict',
    biasLabel:       'center',
    reliability:     0.87,
    countryCode:     'GB',
    ...
    defaultLng:      -0.14,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['iiss', 'conflict', 'defense', 'military', 'analysis'],
    language:        'en',
  },
  {
    id:              'crisis-group',
    ...
    defaultLng:      4.35,
    defaultLocation: 'Brussels, Belgium',
    extraTags:       ['crisis-group', 'conflict', 'peacebuilding', 'analysis'],
    language:        'en',
  },
  {
    ...
    defaultLng:      -73.97,
    defaultLocation: 'New York, United States',
    extraTags:       ['reliefweb', 'humanitarian', 'disaster', 'un', 'crisis'],
    language:        'en',
  },
  {
    id:              'gdacs',
    ...
    extraTags:       ['gdacs', 'disaster', 'earthquake', 'flood', 'cyclone', 'institutional'],
    language:        'en',
  },
  {
    id:              'techcrunch',
    ...
    defaultLng:      -122.42,
    defaultLocation: 'San Francisco, United States',
    extraTags:       ['techcrunch', 'technology', 'startups', 'ai', 'cyber'],
    language:        'en',
  },
  {
    id:              'ars-technica',
    ...
    defaultLng:      -122.42,
    defaultLocation: 'San Francisco, United States',
    extraTags:       ['ars-technica', 'technology', 'science', 'cyber', 'ai'],
    language:        'en',
  },
  {
    id:              'wired',
    ...
    defaultLng:      -122.42,
    defaultLocation: 'San Francisco, United States',
    extraTags:       ['wired', 'technology', 'cyber', 'ai', 'innovation'],
    language:        'en',
  },
  {
    id:              'the-record-cyber',
    ...
    defaultLat:      38.90,
    defaultLng:      -77.04,
    defaultLocation: 'Washington, United States',
    extraTags:       ['recorded-future', 'cyber', 'security', 'threat-intel', 'ransomware'],
    language:        'en',
  },
  {
    id:              'dark-reading',
    ...
    defaultLng:      -122.42,
    defaultLocation: 'San Francisco, United States',
    extraTags:       ['dark-reading', 'cyber', 'security', 'vulnerabilities', 'threat-intel'],
    language:        'en',
  },
  {
    id:              'election-guide',
    name:            'IFES Election Guide',
    feedUrl:         'https://www.electionguide.org/feed/',
    category:        'elections',
    biasLabel:       'center',
    reliability:     0.88,
    countryCode:     'US',
    ...
    defaultLng:      -77.04,
    defaultLocation: 'Washington, United States',
    extraTags:       ['ifes', 'elections', 'democracy', 'voting', 'governance'],
    language:        'en',
  },
  {
    id:              'cdc-outbreaks',
    name:            'CDC Outbreak Updates',
    feedUrl:         'https://tools.cdc.gov/podcasts/feed.asp?feedid=183',
    category:        'health',
    biasLabel:       'center',
    reliability:     0.94,
    countryCode:     'US',
    ...
    defaultLng:      -84.32,
    defaultLocation: 'Atlanta, United States',
    extraTags:       ['cdc', 'health', 'outbreak', 'epidemic', 'institutional'],
    language:        'en',
  },

  // ── Tier 7 — Wire syndication outlets (corroboration strategy) ────────
  // These outlets heavily republish AP/Reuters/AFP wire stories with near-
  // identical headlines. When the correlator sees "Iran nuclear talks stall"
  // from AP, ABC, CBS, and Yahoo within an hour, it clusters them into a
  // corroborated multi-source signal instead of 4 single-source signals.
  {
    id:              'abc-news',
    name:            'ABC News',
    ...
    defaultLng:      -73.98,
    defaultLocation: 'New York, United States',
    extraTags:       ['abc-news', 'wire-syndication', 'ap-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'cbs-news',
    ...
    defaultLng:      -73.97,
    defaultLocation: 'New York, United States',
    extraTags:       ['cbs-news', 'wire-syndication', 'ap-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'nbc-news',
    ...
    defaultLng:      -73.97,
    defaultLocation: 'New York, United States',
    extraTags:       ['nbc-news', 'wire-syndication', 'ap-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'yahoo-news-world',
    name:            'Yahoo News World',
    feedUrl:         'https://news.yahoo.com/rss/world',
    category:        'breaking',
    biasLabel:       'center',
    reliability:     0.78,
    countryCode:     'US',
    defaultLat:      37.40,
    defaultLng:      -122.08,
    defaultLocation: 'Sunnyvale, United States',
    extraTags:       ['yahoo-news', 'wire-syndication', 'ap-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'usa-today-world',
    name:            'USA Today World',
    feedUrl:         'https://rssfeeds.usatoday.com/UsatodaycomWorld-TopStories',
    category:        'breaking',
    biasLabel:       'center',
    reliability:     0.82,
    countryCode:     'US',
    defaultLat:      38.90,
    defaultLng:      -77.02,
    defaultLocation: 'McLean, United States',
    extraTags:       ['usa-today', 'wire-syndication', 'ap-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'cnn-world',
    ...
    defaultLng:      -84.39,
    defaultLocation: 'Atlanta, United States',
    extraTags:       ['cnn', 'wire-syndication', 'ap-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'fox-news-world',
    ...
    defaultLng:      -73.98,
    defaultLocation: 'New York, United States',
    extraTags:       ['fox-news', 'wire-syndication', 'ap-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'sky-news-world',
    ...
    defaultLng:      -0.18,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['sky-news', 'wire-syndication', 'reuters-afp', 'breaking'],
    language:        'en',
  },
  {
    ...
    defaultLng:      -0.11,
    defaultLocation: 'London, United Kingdom',
    extraTags:       ['independent', 'wire-syndication', 'pa-reuters', 'breaking'],
    language:        'en',
  },
  {
    id:              'abc-au-world',
    ...
    defaultLng:      151.21,
    defaultLocation: 'Sydney, Australia',
    extraTags:       ['abc-australia', 'wire-syndication', 'ap-reuters-afp', 'breaking'],
    language:        'en',
  },
]
