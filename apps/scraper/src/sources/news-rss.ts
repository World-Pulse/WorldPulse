 ...
 *
 * Ingests 25 mainstream international news RSS feeds and creates WorldPulse
 ...
 *
 * Competitive rationale: Ground News indexes 50K+ sources; this batch adds 25
 * high-signal international outlets to close the most visible coverage gap.
 */
 ...
 *
 * Polls all 25 registered news outlets every 30 minutes in staggered sequence
