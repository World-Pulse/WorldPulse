...
- Professional but personal tone — this is a founder story, not an ad
- Include 2-3 screenshots as a carousel: map view, signal feed, signal detail
- Tag relevant connections who work in security/risk/OSINT
- Like and reply to every comment within the first 2 hours
- If it gets traction, follow up Thursday with a metrics post
